...
<head>
  ...
  <title>Select SQL iCLOP | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('/')}}"><b>Select SQL iCLOP</b>SSQILOP</a>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0" align="center">
        <a href="#" style="color: black" class="text-center">Copyright © {{date('Y')}} | Arjuna Pratama</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
