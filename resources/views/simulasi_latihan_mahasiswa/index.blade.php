            ...
            <div class="card-header">
              <div class="row">
              	<div class="col-sm-6 pt-2">
              		<h3 class="card-title">Simulasi Latihan Anda</h3>
              	</div>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    @if(strtotime($item->end_date_time) >= $now)
                      @if($nilai[$item->id] > 0)
                        <a href="{{url('simulasi_latihan_kerjakan/'.$item->id.'/'.$item->paket_id.'/'.$soalPertama[$item->id])}}" 
                              style="color: black;" 
                      ...
                      @else
                        @if($pernah[$item->id] != null)
                          <a  href="{{url('simulasi_latihan_kerjakan/'.$item->id.'/'.$item->paket_id.'/'.$pernah[$item->id])}}" 
                              style="color: black;" 
