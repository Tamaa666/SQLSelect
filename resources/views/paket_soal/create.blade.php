          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Data Paket Soal</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('paket_soal/store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama" required class="form-control" placeholder="Contoh : Paket Lathian Semester 1 2023">
                      </div>
                    </div>
                  </div>
                  <div class="row">
