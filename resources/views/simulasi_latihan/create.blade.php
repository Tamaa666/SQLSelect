          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Data Simulasi Latihan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('simulasi_latihan/store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="deskripsi" cols="10" rows="5" placeholder="Simulasi ini ditujukan..."></textarea>
                      </div>
                    </div>
                  </div>
