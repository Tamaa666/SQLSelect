...
<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Simulasi Latihan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Simulasi Latihan</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ubah Data Simulasi Latihan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('simulasi_latihan/update/'.$data->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Nama Simulasi Latihan</label>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Dekripsi Simulasi</label>
                        <textarea class="form-control" name="deskripsi" cols="10" rows="5" placeholder="Simulasi ini ditujukan...">{{$data->deskripsi}}</textarea>
                      </div>
                    </div>
                  </div>
