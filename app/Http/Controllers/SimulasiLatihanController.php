...
use Auth;
use DB;
class SimulasiLatihanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('simulasi_latihan.index',compact('data','materi'));
    }
    ...
    public function create()
    {
        ...
        return view('simulasi_latihan.create',compact('kelas','paket','materi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('simulasi_latihan')->with('success','Berhasil membuat data simulasi');
    }
    ...
    public function edit($id)
    {
        ...
        if(!$data)
        {
            return redirect('simulasi_latihan')->with('error','Gagal mendapatkan data simulasi');
        }
        $kelas = DB::table('kelas')->get();
        $paket = DB::table('paket')->get();
        $materi = DB::table('materi')->get();
        ...
        return view('simulasi_latihan.edit',compact('data','kelas','paket','materi','materiSelected'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('simulasi_latihan')->with('success','Berhasil mengubah data simulasi');
    }

    public function delete($id)
    {
        DB::table('simulasi')->where('id',$id)->delete();
        return redirect('simulasi_latihan')->with('success','Berhasil menghapus data simulasi');
    }
}
